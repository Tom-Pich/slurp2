...
class ArmorsController
{
	...
	const armor_parts = [
		...
		"bras" => ["nom" => "Bras", "mult_pds" => 0.17, "mult_prix" => 0.2, "notes" => null,],
		"jambes" => ["nom" => "Jambes", "mult_pds" => 0.25, "mult_prix" => 0.25, "notes" => "(3)",],
	...
	const armor_sizes = [
		"l" => ["nom" => "grande", "mult_pds" => 1.1, "mult_prix" => 1.1],
		"m" => ["nom" => "normale", "mult_pds" => 1, "mult_prix" => 1],
		"s" => ["nom" => "petite", "mult_pds" => 0.8, "mult_prix" => 0.9],
		"xs" => ["nom" => "très petite", "mult_pds" => 0.6, "mult_prix" => 0.8],
	];

	const shields = [
		// prix [ AD&D, ... ]
		["nom" => "Petit, viking", "DP" => 2, 'pds' => 2.5, 'prix' => [30]],
		["nom" => "Moyen, écu de chevalier", "DP" => 3, 'pds' => 4, 'prix' => [40]],
