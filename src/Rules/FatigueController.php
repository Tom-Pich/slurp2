...
class FatigueController {
	...
	public const levels = [
		...
		"0.2" => [
			"name" => "Épuisé",
			"description" => "<i>For</i>×0.7, <i>San</i> à -1, autres caractéristiques principales à -3",
			"for-multiplier" => 0.7,
			"dex-modifier" => -3,
			"int-modifier" => -3,
			"san-modifier" => -1,
		...
		"0.35" => [
			"name" => "Très fatigué",
			"description" => "<i>For</i>×0.8, autres caractéristiques principales à -2 sauf la <i>San</i>",
			"for-multiplier" => 0.8,
			"dex-modifier" => -2,
			"int-modifier" => -2,
			"san-modifier" => -0,
		...
		"0.5" => [
			"name" => "Fatigué",
			"description" => "<i>For</i>×0.9, autres caractéristiques principales à -1 sauf la <i>San</i>",
			"for-multiplier" => 0.9,
			"dex-modifier" => -1,
			"int-modifier" => -1,
			"san-modifier" => -0,
