...
class CriticalController
{
	public const attack_success = [
		1 => "Dégâts ×2&nbsp;; l’ennemi est sonné (niv. 1) pour ME d’un jet de <i>San</i> actions (min. 1), à moins que les conséquences de la blessure se soient plus sévères.",
		2 => "Dégâts ×2&nbsp;; l’ennemi est sonné (niv. 2) pour ME d’un jet de <i>San</i> actions (min. 1), à moins que les conséquences de la blessure se soient plus sévères.",
		3 => "Dégâts ×2, RD÷2&nbsp;; l’ennemi est sonné (niv. 2) pour ME d’un jet de <i>San</i> -5 actions (min. 1), à moins que les conséquences de la blessure n’indique un résultat supérieur.",
		4 => "Dégâts ×2, RD÷2&nbsp;; l’ennemi est sonné (niv. 2) pour ME d’un jet de <i>San</i> -5 actions (min. 1), à moins que les conséquences de la blessure n’indique un résultat supérieur.",
		5 => "Dégâts ×2, RD÷2&nbsp;; l’ennemi est sonné (niv. 2) pour ME d’un jet de <i>San</i> -5 actions (min. 1), à moins que les conséquences de la blessure n’indique un résultat supérieur.",
		6 => "Dégâts ×3, RD÷3&nbsp;; l’ennemi perd conscience s’il reçoit des dégâts."
	];
	...
	public const contact_weapon_miss = [
		...
		3 => "L’attaquant perd son arme, elle atterrit à 1d mètre de lui ou l’arme se plante dans le décor (choix du MJ). L’arme a 1/6 chance de se briser.",
		...
		5 => "L’attaquant blesse un allié. Si ce n’est pas possible, il perd son arme et elle a 1/6 chance de se briser.",
	...
	public const missile_weapon_miss = [
		1 => "l’arme glisse des mains du personnage. Le tir est manqué et le personnage doit réapprêter son arme.",
		2 => "l’arme glisse des mains du personnage. Le tir est manqué et le personnage doit réapprêter son arme.",
		3 => "le personnage hésite. Il perd le tour.",
		4 => "le personnage hésite. Il perd le tour.",
		5 => "une victime au hasard, dans la direction de la cible, est touchée.",
	...
	public const spell_miss = [
		3 => "Le sort semble agir, mais les effets produits ne sont qu'un pâle ersatz des effets attendus.",
		4 => "Le sort semble agir, mais les effets produits ne sont qu'un pâle ersatz des effets attendus.",
		5 => "Le sort semble agir, mais les effets produits ne sont qu'un pâle ersatz des effets attendus.",
		6 => "Les effets du sort se limitent à un grand bruit suivi de crépitement de lumière colorée.",
		7 => "Le sort échoue. L'initiateur est <i>sonné</i> (niv. 2).",
		8 => "Les effets sont l’inverse de ceux attendus. Refaire un jet si ce n’est pas possible.",
		9 => "Le sort affecte une autre cible au choix du MJ. Refaire un jet si ce n’est pas possible.",
	...
	public static function CriticalResult(string $table_name, int $roll_3d, int $roll_1d)
	{
		...
		return $table[$roll] ?? "Oups&hellip; undefined result!";
