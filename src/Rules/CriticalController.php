...
class CriticalController
{
	...
	public const spell_miss = [
		...
		8 => "Le sort échoue. L'initiateur est sonné (niv. 2). Le nombre d’actions perdues est égale à la ME d’un jet de <i>San</i> (min. 1).",
		...
		12 => "Le sort échoue. L’initiateur subit [1d×niveau de puissance] de dégâts, perd tous ses PdM et ceux de la ou des pierres de puissance qu’il portait.",
