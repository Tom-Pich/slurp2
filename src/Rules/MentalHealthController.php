...
class MentalHealthController {
	...
	public const levels = [
		...
		"0.25" => [
			"description" => "Le personnage est très instable et peut basculer dans une crise de folie aisément. -2 en <i>Volonté</i>, -4 à tous les jets de <i>Sang-froid</i>. Tant qu’il reste en dessous de ce seuil, le personnage souffre d’un désavantage mental à -15 choisi par le MJ. <b>Perte définitive d’un pt de <i>Sang-froid</i> et d’un PdE</b>",
			"sf-modifier" => -3,
			"vol-modifier" => -2,
		],
		"0.5" => [
