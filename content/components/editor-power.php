<form method="post" action="/submit/set-power" autocomplete="off">
	...
	<div class="grid col-2 gap-2">
		<div class="flow">
			...
			<p><b>Catégories existantes&nbsp;:</b> <?= join(", ", $liste_categories) ?></p>

			<h4>Domaine (optionnel)</h4>
			<div class="flex-s mt-½">
			...
			<p><b>Domaines existants&nbsp;:</b> <?= join(", ", $liste_domaines) ?></p>
