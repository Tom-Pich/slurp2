	...
	<form method="post" action="/submit/set-spell" autocomplete="off">
		...
		<div class="flex gap-2">
			<div class="flow fl-1">
				...
				<div class="grid gap-½ ai-center" style="grid-template-columns: 18ch 1fr">
			...
			<textarea name="Description" placeholder="Description du sort" class="p-1 fl-1" required><?= $sort->description ?></textarea>
		</div>
