...
<section>
	...
	<details>
		<summary>
			<h3>Les organes de contrôle, d’expertise et de décision</h3>
		</summary>
	...
	<details>
		<summary>
			<h3>Les grands chefs de service et leurs assistants</h3>
		</summary>
	...
	<details>
		<summary>
			<h3>Relais d’autorité dans les territoires</h3>
		</summary>
...
<!-- Domaines du pouvoirs -->
<section>
	<h2>Domaines du pouvoir</h2>

	<p>Les différents domaines qui doivent être gérés par le pouvoir seigneurial local.</p>
