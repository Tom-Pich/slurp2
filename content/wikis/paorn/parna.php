...
<?php if ($admin): ?>
	<p class="admin">Alchimiste Mortur et sa petite fille Dulnara&nbsp;: rencontré par le groupe de Nessalanta sur le bateau de Laelith.</p>
	<p class="admin">Le mage Telxis, auprès duquel Jurgen se forme au collège de <i>Mouvement</i>.</p>
<?php endif ?>

<p><b>Route de Parna à Mikalas&nbsp;:</b> voir <a href="/wiki/paorn/mikalas">Mikalas</a>.</p>