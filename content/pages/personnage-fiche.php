...
<div class="character-sheet-wrapper fl-1">
	...
	<fieldset>
		<legend class="flex-s gap-½ ai-center">
			Possessions
			<button class="ff-far fs-200 btn-primary px-½ py-¼" data-role="open-dialog" data-dialog-name="possession-notice" title="mode d’emploi de la liste de possession">&#xf059;</button>
		</legend>
		...
		if (!empty($character->id_group)):
			...
			if ($possessions_communes) { ?>
				<details class="mt-½ flow no-print">
					<summary class="h4">Possessions de groupe</summary>
