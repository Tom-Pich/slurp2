...
<article><h2>Bases de la magie</h2>

	<details><summary class="h3">Principes directeurs</summary>
	...
	<details><summary class="h3">Terminologie</summary>
		<p>
	...
	<details><summary class="h3"><div>L’avantage <i>Magerie</i></div></summary>
		...
		<table class="alternate-e">
			<tr><th>Niv.</th>	<th>Coût</th>	<th>Int</th>	<th>Modif.</th>	<th>Détection</th>	<th>PdM</th>	<th>Impro</th></tr>
			<tr><td>1</td>	<td>20</td>	<td>-</td>	<td>-2</td>	<td>8</td>	<td>0</td>	<td>12</td></tr>
			<tr><td>2</td>	<td>30</td>	<td>12</td>	<td>-1</td>	<td>11</td>	<td>5</td>	<td>14</td></tr>
			<tr><td>3</td>	<td>40</td>	<td>14</td>	<td>0</td>	<td>13</td>	<td>10</td>	<td>17</td></tr>
			<tr><td>4</td>	<td>55</td>	<td>16</td>	<td>+1</td>	<td>15</td>	<td>15</td>	<td>20</td></tr>
			<tr><td>5</td>	<td>75</td>	<td>18</td>	<td>+2</td>	<td>auto.</td>	<td>&infin;</td>	<td>25</td></tr>
		</table>
		...
		<b>Impro&nbsp;:</b> limite du score de compétence du collège en cas d'improvisation.</p>
	</details>
	
	<details><summary class="h3">Apprendre un Collège de magie</summary>
	...
	<details><summary class="h3">Niveau de puissance des sorts</summary>
	...
	<details><summary class="h3">Classes de sorts</summary>
		...
		<details><summary class="h4">Régulier</summary>
			...
			<p><b>Portée&nbsp;:</b> -1 par mètre entre le sujet de l’initiateur (min. -1 si ce dernier ne touche pas le sujet)&nbsp;; -3 si l’initiateur ne peut ni toucher ni voir le sujet (voir par des substituts magiques fonctionne).</p>
		...
		<details><summary class="h4">Zone</summary>
			...
			<p><b>Taille de la zone&nbsp;:</b> la description des sorts de zone mentionne une <i>Zone de base</i>. C’est le <i>diamètre</i> de la zone d’effet, en mètres, pour un coût énergétique standard. Augmenter le diamètre de la zone implique une augmentation proportionnelle du coût énergétique.</p>
		...
		<details><summary class="h4">Projectile</summary>
		...
		<details><summary class="h4">Blocage</summary>
		...
		<details><summary class="h4">Information</summary>
		...
		<details><summary class="h4">Enchantement</summary>
		...
		<details><summary class="h4">Sorts spéciaux</summary>
...
<article><h2>Lancer un sort</h2>
	<details><summary class="h3">Modificateurs</summary>
	...
	<table class="alternate-e">
		...
		<tr>
			<th>rapide</th>	<th>long</th>
		</tr>
		<tr><td>I</td>		<td>0</td>		<td>2</td>		<td><?= Spell::cast_time[0][0] ?>&nbsp;s</td>	<td><?= Spell::cast_time[0][1] ?>&nbsp;s</td></tr>
		<tr><td>II</td>		<td>-2</td>		<td>4</td>		<td><?= Spell::cast_time[1][0] ?>&nbsp;s</td>	<td><?= Spell::cast_time[1][1] ?>&nbsp;s</td></tr>
		<tr><td>III</td>	<td>-5</td>		<td>6</td>		<td><?= Spell::cast_time[2][0] ?>&nbsp;s</td>	<td><?= Spell::cast_time[2][1]/60 ?>&nbsp;min</td></tr>
		<tr><td>IV</td>		<td>-8</td>		<td>8</td>		<td><?= Spell::cast_time[3][0] ?>&nbsp;s</td>	<td><?= Spell::cast_time[3][1]/60 ?>&nbsp;min</td></tr>
		<tr><td>V</td>		<td>-13</td>	<td>15+</td>	<td><?= Spell::cast_time[4][0] ?>&nbsp;s</td>	<td><?= Spell::cast_time[4][1]/3600 ?>&nbsp;h</td></tr>
	</table>
	<p>* Sauf indication contraire dans la description du sort.</p>
	</details>

	<details><summary class="h3">Réduction du coût énergétique</summary>
	...
	<p>Cette réduction s’applique au coût de lancer du sort et au coût de maintien. Le score à prendre en compte est le score brut. Un sort suffisamment maîtrisé peut donc devenir gratuit à prolonger voire à lancer.</p></details>
	
	<details><summary class="h3">Temps et rituel nécessaire</summary>
	...
	<details><summary class="h3">Durée et prolongation</summary>
	...
	<p><b>Prolonger un sort&nbsp;:</b> aucun jet n’est nécessaire, l’initiateur paye la moitié du coût de base du sort pour le prolonger de sa durée de base (ou moins s'il le spécifie). L’initiateur doit être conscient et éveillé, même si la prolongation ne lui coûte aucun PdM.</p></details>
	...
	<table class="alternate-e left-1">
		...
		<tr><td>&le; 1 km</td>	<td>-2</td></tr>
		<tr><td>&le; 3 km</td>	<td>-3</td></tr>
		<tr><td>&le; 10 km</td>	<td>-4</td></tr>
		<tr><td>&le; 30 km</td>	<td>-5</td></tr>
		<tr><td>&le; 100 km</td>	<td>-6</td></tr>
		<tr><td>&le; 300 km</td>	<td>-7</td></tr>
		<tr><td>&le; 1000 km</td>	<td>-8</td></tr>
		<tr><td>chaque ×3</td>	<td>-1 sup.</td></tr>
	</table></details>

	<details><summary class="h3">Réussite, échec et échec critique</summary>
...
<article><h2>Effets génériques des sorts</h2>
	...
	<table class="alternate-e left-1">
		...
		<tr><td>Résistance aux dégâts<sup>(1)</sup></td><td>+2</td>			<td>+4</td>			<td>+6</td>			<td>+10</td>		<td>&infin;</td></tr>
		<tr><td>Dégâts standard<sup>(2)</sup></td>	<td>1d</td>				<td>2d</td>			<td>4d</td>			<td>7d</td>			<td>(18d)</td></tr>
		<tr><td>Dégâts P-Ex-sRD<sup>(3)</sup></td>	<td>1d-1</td>			<td>1d+2</td>		<td>3d</td>			<td>5d</td>			<td>(12d)</td></tr>
		<tr><td>Dégâts répétés<sup>(4)</sup></td>	<td>1d-2</td>			<td>1d</td>			<td>2d</td>			<td>3d+2</td>		<td>(9d)</td></tr>
		<tr><td>Bonus de dégâts standards (BDS)</td><td>+2</td>				<td>+1d+1</td>		<td>+2d</td>		<td>+3d</td>		<td>(+7d+2)</td></tr>
	</table>
	...
	<b>(5)</b> Quand des effets sont mentionnés pour un niveau de puissance V, il s’agit des effets obtenus lorsque le sort coûte 15 PdM, sauf mention contraire. Les effets peuvent être plus puissants encore si le coût énergétique est augmenté. Ceci n’est valable que pour les sorts de niveau V.</p>
	</details>

	<details><summary class="h3">Modificateurs spécifiques</summary>
		...
		<b>Jet de défenses ou de résistance&nbsp;:</b> standard ×2</p>
	</details>

	<details><summary class="h3">Détruire un objet inanimé</summary>
	...
	<b>Niv. V&nbsp;:</b> Comme un engin de chantier de type bulldozer.</p>
	</details>

	<details><summary class="h3">Invocation de créatures</summary>
	...
	<b>Niv. V&nbsp;:</b> créature très puissante (démon majeur).</p>
...
<article><h2>Résister à un sort</h2>
	<details><summary class="h3">Jet de résistance</summary>
		...
		<b>Cible = autre sort&nbsp;:</b> aucune limite</p>
		<p>Résister à un sort de niveau V se fait toujours à -3, en plus de la MR du sort.</p>
	</details>

	<details><summary class="h3">Effets d’une résistance réussie</summary>
	...
	<details><summary class="h3">Résistance et tentatives répétées</summary>
...
<article><h2>Points de magie</h2>
	...
	<details><summary class="h3">Récupération</summary>
	...
	<details><summary class="h3">Dépenser des PdF</summary>
...
<article><h2>Fluide</h2>
	...
	<details><summary class="h3">Niveaux de fluide</summary>
	...
	<details><summary class="h3">Perception du fluide</summary>
	...
	<details><summary class="h3">Fluide orienté</summary>
...
<article><h2>Pouvoirs magiques</h2>

	<details><summary class="h3">Définition</summary>
	...
	<details><summary class="h3">Jet de réussite</summary>
	...
	<p>Un échec critique entraîne une dépense normale de PdM et le personnage perd l’usage de son pouvoir pendant (lancer 1d)&nbsp;: 1&nbsp;: 1d heure(s) ; 2-3&nbsp;: 2d heures ; 4-5&nbsp;: 1d jour(s) ; 6&nbsp;: 2d jours.</p></details>
	
	<details><summary class="h3">Coût énergétique, Temps nécessaire &amp; rituels</summary>
	<p>Ces trois paramètres n'évoluent pas avec le score de compétence.</p>
	<p>Le déclenchement d’un pouvoir ne nécessite aucun geste ni aucune parole mais demande tout de même un temps de concentration durant lequel il n’est possible de se déplacer que d’un mètre par seconde.</p></details>
	
	<details><summary class="h3">Améliorations et limitations</summary>
	...
	Peu fiable&nbsp;: le pouvoir ne se déclenche pas toujours, indépendamment du niveau de compétence.</p></details>
</article>

<article><h2>Créer ou modifier un sort</h2>
	<p>Un mage peut inventer des sorts ou modifier les caractéristiques de sorts qu’il connaît.</p>

	<details><summary class="h3">Modifier un sort existant</summary>
	...
	Appliquer les modificateurs de longue distance → augmente le niveau de puissance de 1.</p></details>

	<details><summary class="h3">Inventer un nouveau sort</summary>
...
<article><h2>Magie collective</h2>
	...
	<details><summary class="h3">Rituel</summary>
	...
	<details><summary class="h3">Réussites &amp; échecs</summary>
	...
	<details><summary class="h3">Maintenir un sort de magie rituelle</summary>
	...
	<details><summary class="h3">Échange d’énergie contre compétence</summary>
...
<article><h2>Objets magiques</h2>

	<details><summary class="h3">Utilisation</summary>
	...
	<details><summary class="h3">Création</summary>
		...
		<div class="exemple">
		Un mage souhaite recharger une <i>Baguette de boules de feu</i> III. Il doit donc être capable de lancer <i>Boule de feu</i> au niveau III avec un score ≥ 15. Chaque charge lui coûtera 6 PdM (coût normal d’un sort de niveau III).
		</div>
	</details>

</article>

<article><h2>Alchimie</h2>
	...
	<details><summary class="h3">Utilisation d’objets alchimiques</summary>
	...
	<p>Pour analyser un élixir, un alchimiste doit disposer de son laboratoire et réussir un jet d’<i>Alchimie</i>. L’analyse prend 10 minutes. Sans laboratoire, le jet est à -5.</p></details>

	<details><summary class="h3">Fabrication</summary>
	...
	<table class="alternate-e left-2">
		...
		<tr><td>10-12</td>	<td>Une explosion détruit le labo ; l’alchimiste a le temps d’évacuer.</td></tr>
		<tr><td>13-15</td>	<td>Une explosion détruit le labo ; l’alchimiste subit 3d de dégâts.</td></tr>
		<tr><td>16-18</td>	<td>Une explosion détruit le labo ; l’alchimiste subit 6d de dégâts.</td></tr>
	</table>
	...
	<p><b>Labo high tech&nbsp;:</b> pièce de 20 m², un équipement ultrasophistiqué de NT6 au moins, comprenant des chronomètres, des réfrigérateurs, des récipients de chimiste en verre et des instruments de mesure précis. +2 à la compétence.</p></details>
</article>

<article><h2>Familier</h2>
	...
	<details><summary class="h3">Acquérir un familier</summary>
	...
	<details><summary class="h3">Pouvoirs conférés</summary>
	...
	<details><summary class="h3">Limitations des familiers</summary>
