...
<article>
	...
	<details>
		...
		<table class="left-2">
			...
			<tr>
				<td>2</td>
				<td>Erreur minime. Les conséquences sont minimales.</td>
			</tr>
			<tr>
				<td>3-4</td>
				<td>Erreur moyenne. Les conséquences sont celles «&nbsp;raisonnablement attendues&nbsp;» pour un accident dans ces conditions.</td>
			</tr>
			<tr>
				<td>5-6</td>
				<td>Erreur grave. Les occupants du véhicule sont assez malchanceux, les conséquences sont graves.</td>
			</tr>
			<tr>
				<td>7+</td>
				<td>Erreur catastrophique. Le pire se produit.</td>
			</tr>
		</table>
...
<article>
	...
	<details>
		...
		<table class="left-1">
			...
			<tr>
				<td>Légers ou niv. 1</td>
				<td>jusqu’à 1d-3</td>
			</tr>
			<tr>
				<td>Moyens ou niv. 2</td>
				<td>jusqu’à 2d</td>
			</tr>
			<tr>
				<td>Grave ou niv. 3</td>
				<td>jusqu’à 6d</td>
			</tr>
			<tr>
				<td>Très grave ou niv. 4</td>
				<td>jusqu’à 6d×2</td>
			</tr>
			<tr>
				<td>Extrême ou niv. 5</td>
				<td>jusqu’à 6d×4</td>
			</tr>
		</table>
	...
	<details>
		<summary>
			<h3>Types d’effets secondaires</h3>
		</summary>
		...
		<table class="alternate-o left-2">
			<tr>
				<th>1</th>
				<td>Convertisseur d’énergie : Moteur, réacteur.</td>
			</tr>
			<tr>
				<th>2</th>
				<td>Occupants : Pilote(s) ou passagers, pont de commande, quartiers de l’équipage, etc.</td>
			</tr>
			<tr>
				<th>3</th>
				<td>Systèmes de propusion et manœuvre : Roue, chenille, hélice, aileron, gouvernail, freins, etc.</td>
			</tr>
			<tr>
				<th>4</th>
				<td>Systèmes structurels : Porte, sas, tourelle, bras manipulateur, etc.</td>
			</tr>
			<tr>
				<th>5</th>
				<td>Équipement divers : arme, senseurs, système de survie, ordinateur de bord, et tout système qui n’est pas essentiel à la bonne marche immédiate du véhicule.</td>
			</tr>
			<tr>
				<th>6</th>
				<td>Source d’énergie : Réservoir de carburant, générateur, chaudière, batteries, etc.</td>
			</tr>
		</table>
	</details>
</article>
...
<article>
	...
	<details>
		<summary>
			<h3>Voiture à moteur thermique</h3>
		</summary>
