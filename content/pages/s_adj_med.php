<article> <!-- Démographie -->
	...
	<details><summary class="h3">Densité de population</summary>
	...
	<table class="alternate-e">
		<tr><th>Densité</th>	<th>Village</th>	<th>Bourg</th>			<th>Ville</th></tr>
		<tr><td>Éparse</td>		<td>30-50 km</td>	<td>130-20 km</td>		<td>-</td></tr>
		<tr><td>Moyenne</td>	<td>10-30 km</td>	<td>50-100 km</td>		<td>130-200 km</td></tr>
		<tr><td>Dense</td>		<td>8-20 km</td>	<td>30-50 km</td>		<td>60-110 km</td></tr>
	</table>
	</details>

	<details><summary class="h3">Taille des agglomérations</summary>
...
<article> <!-- Commerces & échoppes -->
	...
	<details><summary class="h3">Communs (200-400 habitants)</summary>
	<p>
		Barbier<br/>
		Cordonnier<br/>
		Forgeron<br/>
		...
		Pâtissier (nourriture à emporter &ndash; sucré et salé)<br/>
	...
	<details><summary class="h3">Assez communs (800-1000 habitants)</summary>
	<p>
		Artisan du cuir<br/>
		Auberge<br/>
	...
	<details><summary class="h3">Peu répandus (1700-2000 habitants)</summary>
	<p>
	...
	<details><summary class="h3">Rares (2500-5000 habitants)</summary>
	<p>
	...
	<details><summary class="h3">Très rares (5000+ habitants)</summary>
	<p>
...
<article> <!-- Métiers sans échoppe -->
	...
	<details><summary class="h3">Construction</summary>
		Couvreur<br/>
		Fossoyeur<br/>
		Ingénieur<br/>
		Maçon<br/>
	...
	<details><summary class="h3">Mines</summary>
		Abatteur (détache le minerai et le concasse avant manutention)<br/>
		Manutentionnaire (charge et transporte le minerai)
	</details>

	<details><summary class="h3">Professions intellectuelles</summary>
		Avocat<br/>
		Érudit<br/>
		Prêtre
	</details>

	<details><summary class="h3">Métiers de pauvres</summary>
	...
	<details><summary class="h3">Divers</summary>
	...
	<details><summary class="h3">Officiels</summary>
	...
	<details><summary class="h3">À la campagne</summary>
		Apiculteur<br/>
...
<article> <!-- Marchandises -->
	...
	<details><summary class="h3">Aliments &amp; boissons</summary>
		<b>Céréales&nbsp;:</b> blé, orge, avoine, seigle<br/>
		<b>Légumes&nbsp;:</b> navets, chou, céleri, carottes, fèves, pois, haricots, lentille, ail, oignon<br/>
		<b>Fruits&nbsp;:</b> raisins, pommes, châtaignes, poires, coing, pêches, abricots<br/>
		<b>Sel &amp; épices&nbsp;:</b> sel, poivre, gingembre, cannelle, clou de girofle, safran<br/>
		<b>Herbes aromatiques&nbsp;;</b> persil, sauge, romarin, thym, marjolaine, menthe, origan, sarriette<br/>
		<b>Produits animaux&nbsp;:</b> œufs, fromages, beurre, lait (vache, brebis, chèvre)<br/>
		<b>Viandes&nbsp;:</b> bœuf, mouton, porc, chèvre<br/>
		<b>Volailles&nbsp;:</b> poulet, canard, oie, dinde, caille, cygne<br/>
		<b>Charcuterie&nbsp;:</b> saucisses, boudin, pâté, jambon, lard, viande séchée<br/>
		<b>Gibier&nbsp;:</b> cerf, daim, biche, sanglier, faisan, perdrix, coq de bruyère<br/>
		<b>Poissons&nbsp;:</b> hareng, morue, truite, carpe<br/>
		<b>Condiments&nbsp;:</b> vinaigre, huile<br/>
		<b>Alcools&nbsp;:</b> vin, hydromel, liqueur, eau-de-vie, cidre, bière<br/>
	</details>

	<details><summary class="h3">Biens de consommation courante</summary>
		<b>Vaisselle&nbsp;:</b> carafe, assiette, bol, cuillère, en terre cuite, en étain, en argent, en cuivre, en bois, en verre<br/>
		<b>Ustensiles de cuisine&nbsp;:</b> poêle, marmite, chaudron, louche, couteau, pots<br/>
		...
		<b>Éclairage&nbsp;:</b> chandelle, bougie, suif, cire, huile, lampe, briquet, torche, bougeoir<br/>
		<b>Outils&nbsp;:</b> marteau, maillet, ciseau(x), scie, rabot, clous, pointes, pitons, pierre à affûter, pinces, tenailles, huile à lubrifier, chiffons, ficelle, lanières, poinçon, corde à nœuds, craie, faux, faucille, houe, lame d'araire ou de charue, meule de pierre<br/>
		<b>Confection&nbsp;:</b> soie, velours, chanvre, laine, lin, fourrure, cuir, feutre, dentelle, matériel de couture, de tissage, de filage de brodage<br/>
		<b>Vêtements&nbsp;:</b> chemise, robe, jupe, gilet, cape, tunique, surcot, pantalons (chausse, braies…), chaussures<br/>
		<b>Accessoires vestimentaires&nbsp;:</b> ceinture, tablier, foulard, châle, écharpe, gants, coiffe, chapeau, capuche, ruban, épingle<br/>
		<b>Matériel pour fumer&nbsp;:</b> tabac ou autres plantes, pipes, tabatière<br/>
		<b>Lecture &amp; écriture&nbsp;:</b> livre, parchemin, encre, papier, plume, cire<br/>
		<b>Bijoux&nbsp;:</b> anneau, bracelet, boucles d'oreille, pectoral, chevil&shy;lère, broche, gorgerin, fibule<br/>
		<b>Objets religieux&nbsp;:</b> statuette, icône, symbole religieux, encens, encensoir<br/>
		<b>Toilette &amp; hygiène personnelle&nbsp;:</b> miroir, peigne, savon, brosse, gant de crin<br/>
		<b>Mobilier&nbsp;</b> armoire, bahut, crédence, siège, table, coffre<br/>
		<b>Harnachement&nbsp;:</b> selle, couverture de selle, brides, sac à nourriture, rênes, fouet, entrave, harnais, barde.<br/>
		<b>Système de fermeture&nbsp;:</b> cadenas, clenche, charnière, gond, loquet, serrure<br/>
		<b>Herbes médicinales et remèdes</b>
	</details>

	<details><summary class="h3">Ressources végétales</summary>
		Cultures (légumes, céréales, fruits, condiments, herbes aromatiques)<br/>
		Produits de la forêt (glands, faînes, merises, pommes sauvages, nèfles, aubépine, cynorhodons, noix, noisettes, chataîgnes, prunelles, framboises, mures, fraises, plantes médicinales et aromatique).<br/>
		Bois (chauffage, construction, ébénisterie, vannerie, écorce pour tannerie)<br/>
		Espèces rares (champignons, plantes médicinales)<br/>
		Brai (goudron végétale pour étanchéifier toits et murs)
	</details>

	<details><summary class="h3">Ressources animales</summary>
		Élevage (viande, cuir, graisse, fourrure, lait, miel, œufs)<br/>
		Chasse (même matières premières)<br/>
		Pêche
	</details>

	<details><summary class="h3">Ressources minérales &amp; métaux</summary>
		Sel<br/>
		Pierre (pierre de taille, argile, boues)<br/>
		Métaux (cuivre, fer, plomb, étain, mercure, or, argent, (mithrill))<br/>
		Autres minéraux (sels, cristaux)
	</details>
</article>
...
<article>  <!-- Paysans & agriculture -->
	...
	<details><summary class="h3">Travaux de saisons</summary>
	...
	<details><summary class="h3">Outils &amp; techniques agricoles</summary>
		...
		<b>Autres instruments&nbsp;:</b> faucille, faux, râteau, fourche, fléau à grains.</p>
	...
	<details><summary class="h3">Récoltes et produits</summary>
	...
	<details><summary class="h3">Corvées, taxes &amp; impôts</summary>
	...
	<details><summary class="h3">Différents types de paysans</summary>
...
<article> <!-- Voyageurs -->
	...
	<details><summary class="h3">Gens du commun</summary>
	...
	<details><summary class="h3">Marchands et artisans itinérants</summary>
		...
		<p class="interligne">D’autres exemples de marchand et artisans itinérant&nbsp;:</p>
	...
	<details><summary class="h3">Dignitaires</summary>
	...
	<details><summary class="h3">Saltimbanques</summary>
	...
	<details><summary class="h3">Équipement du voyageur</summary>
		<h4>La base</h4>
		<p>
