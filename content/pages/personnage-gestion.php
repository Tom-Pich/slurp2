...
<form id="noyau" method="post" action="/submit/update-character" enctype="multipart/form-data">
	...
	<article>
		...
		<!-- Nouveaux Avdésav -->
		<details>
			<summary class="ajouter">Ajouter</summary>
		...
		<div class="mt-½">
			...
			foreach ($character->skills as $comp) { ?>
				...
				<div class="flex-s gap-½ ai-first-baseline">
					...
					<input type="text" name="Compétences[<?= $n_post ?>][score]" value="<?= $comp['score'] ?>" size="2" class="center" title="score">
			...
			<div class="mt-½">
				...
				?>
					<details class="fs-300">
						...
						<div class="flex-s jc-flex-between mt-½ gap-½">
